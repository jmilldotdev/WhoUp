...
export function MoonPhaseViewer() {
  const getTodaysMoonPhase = (): number => {
    ...
    const lp = 2551443; // Lunation period in days * 10000
    const new_moon = new Date(2000, 0, 6, 18, 14, 0); // Known new moon date
    const phase_diff = ((today.getTime() - new_moon.getTime())/86400000) % 29.530588853;
    ...
    <>
      ...
      <div className={styles.page}>
        ...
        >
          ...
          <div className={styles.moonPhaseScroller} style={{ marginTop: '-50px' }}>
